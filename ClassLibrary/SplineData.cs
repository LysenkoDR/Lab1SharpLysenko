...
namespace ClassLibrary
{
    public class SplineData
    {
        ...
        public void MakeMKLSpline()
        {
            ...
            //double[] Coord = new double[NumberSplineGridNodes];
            ...
            //if (isU == true)
            //{
            //    x_values = new double[] { RawData.LeftEndPoint, RawData.RightEndPoint };

            //}
            //else
            //{
            //    x_values = new double[num_points_x];
            ...
            //double[] sites = Array.Empty<double>();

            //if (isU == true)
            //{
            //    sites = new double[num_sites];
            //    sites[0] = RawData.LeftEndPoint;
            //    sites[num_sites - 1] = RawData.RightEndPoint;
            //}
            //else
            ...
            //    {
            //        sites[i] = sites[i - 1] + (RawData.RightEndPoint - RawData.LeftEndPoint) / NumberSplineGridNodes;
            //    }
            //}
            ...
            try
            {
                ...
                //                x_values, y_values, 
                //                boundary_conditions, spline_coefficients,
                //                num_sites, sites, num_derivatives, 
                //                derivative_orders, interpolated_values, 
                //                ref return_status, nlim, left_limit, right_limit, 
                //                integral_result, IsU);


                //this.IntegralValue = integral_result[0];
